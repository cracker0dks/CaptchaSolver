...
5. Copy the "JDownloader 2.0" content into your current JD2 folder (probably `~/.jd` if you installed via flatpack try: /home/*username*/.var/app/org.jdownloader.JDownloader/data/jdownloader)
